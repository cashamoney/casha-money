...
function CatIcon({ category }: { category: string }) {
  ...
  const icons: Record<string, React.ReactElement> = {
    ...
    Shopping: <svg width={s} height={s} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><circle cx="12" cy="13" r="8" /><path strokeLinecap="round" d="M12 2v4m0 0c-2 0-3 1.5-3 3h6c0-1.5-1-3-3-3zM12 9v4" /></svg>,
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          .xsum { grid-templateColumns: 1fr !important; }
