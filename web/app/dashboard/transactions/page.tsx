...
const CATEGORIES: Record<string, { color: string; icon: React.ReactNode }> = {
  ...
  "Refund": { color: "#86EFAC", icon: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 10h10a5 5 0 010 10H9m0 0l3-3m-3 3l3 3M3 10l3-3m-3 3l3 3" /></svg> },
