...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      display: "grid", gridTemplateColumns: "43% 57%",
      ...
      <div style={{
        ...
        display: "flex", alignItems: "center", justifyContent: "center", padding: "34px 40px",
      }}>
        <div style={{
        ...
        <div style={{
          ...
          {/* BULLETS — perfectly centered as a block */}
      ...
      <div style={{
        ...
        justifyContent: "center", padding: "28px 40px", overflow: "hidden",
      }}>
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
                <label style={{ fontSize: "11px", fontWeight: 600, color: "#374151" }}>Password</label>
                <a href="#" style={{ fontSize: "11px", color: "#22C55E", textDecoration: "none", fontWeight: 600 }}>Forgot?</a>
              </div>
