...
export default function Home() {
  ...
  const features = [
    ...
    { tag: "SMS Parser", h: "Paste bank SMS. Transaction created.", p: "Works with every Indian bank. Paste any message — amount, merchant, and category extracted in one second.", icon: <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>, code: `HDFC Bank SMS:\nRs.2,500.00 debited from A/c XX1234\non 19-04-26. Info: Swiggy.\n\nParsed:\nAmount    Rs.2,500\nMerchant  Swiggy\nCategory  Food Delivery\nDate      19 Apr 2026` },
    ...
    { tag: "Subscriptions", h: "Find money you forgot you were spending.", p: "Automatically detects every active subscription from your transactions — even ones you completely forgot about.", icon: <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>, code: `Detected  —  April 2026\n\nNetflix       Rs.499/mo\nHotstar       Rs.299/mo\nSpotify       Rs.119/mo\nGym (unused)  Rs.1,999/mo\n\nMonthly waste:  Rs.2,916\nAnnually:       Rs.34,992` },
  ];

  const rule = [
    { pct: "50", label: "Needs", color: T.blue, amount: "Rs.37,500", items: ["Housing & Rent", "Groceries", "EMI Payments", "Insurance", "Utilities", "Transport"] },
    { pct: "30", label: "Wants", color: T.amber, amount: "Rs.22,500", items: ["Dining & Delivery", "Shopping", "Entertainment", "Subscriptions", "Travel", "Personal Care"] },
    { pct: "20", label: "Savings", color: T.green, amount: "Rs.15,000", items: ["Emergency Fund", "SIP / Mutual Funds", "PPF & NPS", "ELSS (Tax Saving)", "Fixed Deposit", "Gold"] },
  ];
  ...
  const testimonials = [
    { text: "Found Rs.2,916/month in forgotten subscriptions. Tax optimizer then found Rs.38,000 in deductions my CA had missed for two years.", name: "Rahul Mehta", role: "Software Engineer, Bangalore" },
    { text: "SMS parser is the best feature in any Indian finance app. Transactions appear instantly with the right category. Every single time.", name: "Priya Sharma", role: "Marketing Manager, Mumbai" },
    { text: "Switched to Old Regime after Casha's analysis. Invested in ELSS. Saved Rs.42,000 in taxes. My CA confirmed every recommendation.", name: "Arun Kumar", role: "Startup Founder, Hyderabad" },
  ];

  const faqs = [
    { q: "Is the free plan actually free — forever?", a: "Yes. No credit card, no trial expiry, no hidden charges. The free plan includes transaction tracking, tax optimizer, debt planner, budget AI, and 10 AI questions per day — permanently. We earn from Plus subscribers who need advanced features." },
    { q: "How does Casha access my bank transactions?", a: "It does not access your bank directly. You add transactions by pasting bank SMS messages — works with all Indian banks — or by entering manually. We never ask for your internet banking password, OTP, or any credentials." },
    { q: "Is my financial data safe?", a: "We use AES-256 encryption, the same standard used by SBI and HDFC. Each user's data is completely isolated — no one else can read your transactions. We never sell your data to any third party." },
    ...
    { q: "What is the 50/30/20 rule?", a: "50% of income goes to needs (rent, EMI, groceries), 30% to wants (dining, shopping, entertainment), and 20% to savings and investments. Casha adapts this for Indian income levels and generates your budget automatically with one click." },
    ...
    { q: "Is Casha a registered financial advisor?", a: "No. Casha is a financial education platform, not a SEBI-registered advisor or licensed tax professional. All AI recommendations are educational only. Please consult a qualified CA or SEBI advisor before making significant decisions." },
  ];

  const W = { maxWidth: "1080px", margin: "0 auto", padding: "88px 24px" } as React.CSSProperties;
  const H2 = { fontSize: "clamp(26px, 3.8vw, 44px)", fontWeight: "800", color: T.text, letterSpacing: "-0.03em", lineHeight: "1.1", margin: "0 0 14px 0" } as React.CSSProperties;
  const BODY = { fontSize: "17px", color: T.muted, lineHeight: "1.7", margin: "0 0 40px 0" } as React.CSSProperties;
  const CARD = { background: T.card, border: `1px solid ${T.border}`, borderRadius: "14px", padding: "26px" } as React.CSSProperties;
  ...
  return (
    <div style={{ fontFamily: "'Inter', 'Helvetica Neue', system-ui, sans-serif", background: T.white, color: T.text, overflowX: "hidden" }}>
      ...
      <header style={{
        ...
        height: "62px", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 40px",
        ...
        <a href="/" style={{ display: "flex", alignItems: "center", gap: "9px", textDecoration: "none" }}>
          <div style={{ width: "32px", height: "32px", borderRadius: "9px", background: "#22C55E", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontSize: "16px", fontWeight: "900", color: "#0A0A0A", lineHeight: 1 }}>c</span>
          </div>
      ...
      <section style={{ paddingTop: "140px", paddingBottom: "80px", paddingLeft: "24px", paddingRight: "24px", textAlign: "center" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(46px, 7vw, 86px)", fontWeight: "800", color: T.black, letterSpacing: "-0.04em", lineHeight: "1.02", margin: "0 0 20px 0" }}>
            Your money,<br />
            <span style={{ background: "linear-gradient(135deg, #16A34A, #22C55E, #4ADE80)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>finally</span>
            {" "}<span style={{ color: T.black }}>making sense.</span>
          </h1>

          <p style={{ fontSize: "19px", color: T.muted, lineHeight: "1.65", maxWidth: "520px", margin: "0 auto 36px" }}>
      ...
      {/* APP PREVIEW */}
      <section style={{ padding: "0 24px 88px", maxWidth: "980px", margin: "0 auto" }}>
        <Fade>
          <div style={{ border: `1px solid ${T.border}`, borderRadius: "16px", overflow: "hidden", boxShadow: "0 2px 4px rgba(0,0,0,0.04), 0 16px 48px rgba(0,0,0,0.08)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "190px 1fr" }}>
              ...
              <div style={{ background: T.white, borderRight: `1px solid ${T.border}`, padding: "18px 10px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "7px", padding: "0 6px", marginBottom: "22px" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "6px", background: T.green, display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                {["Overview", "Transactions", "Budget", "Debts", "Tax Genius", "AI Advisor", "Settings"].map((n, i) => (
                  <div key={n} style={{ padding: "8px 10px", borderRadius: "8px", marginBottom: "1px", background: i === 0 ? "#F4F4F5" : "transparent", fontSize: "13px", color: i === 0 ? T.black : T.faint, fontWeight: i === 0 ? "600" : "400" }}>{n}</div>
                ))}
              </div>
              {/* Main */}
              <div style={{ background: T.surface, padding: "24px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                  <div>
                    <p style={{ fontSize: "11px", color: T.faint, margin: "0 0 3px 0" }}>Sunday, 20 April 2026</p>
                    <p style={{ fontSize: "18px", fontWeight: "700", color: T.black, margin: 0, letterSpacing: "-0.02em" }}>Good afternoon, Rahul</p>
                  </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px", marginBottom: "10px" }}>
                  {[
                    ...
                    <div key={i} style={{ background: m.dark ? T.black : T.white, border: m.dark ? "none" : `1px solid ${T.border}`, borderRadius: "11px", padding: "13px" }}>
                      <p style={{ fontSize: "10px", fontWeight: "700", letterSpacing: "0.06em", textTransform: "uppercase", color: m.dark ? "rgba(255,255,255,0.3)" : T.faint, margin: "0 0 6px 0" }}>{m.l}</p>
                      <p style={{ fontSize: m.dark ? "24px" : "18px", fontWeight: "800", color: m.dark ? (m.vc || T.white) : T.text, margin: "0 0 3px 0", letterSpacing: "-0.02em" }}>{m.v}</p>
                      <p style={{ fontSize: "11px", color: m.dark ? "rgba(255,255,255,0.28)" : T.muted, margin: 0 }}>{m.s}</p>
                    </div>
                  ))}
                </div>
                <div style={{ background: T.white, border: `1px solid ${T.border}`, borderRadius: "10px", padding: "12px 14px", marginBottom: "10px" }}>
                  <div style={{ display: "flex", gap: "10px" }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "11px", color: T.muted, margin: 0, lineHeight: "1.5" }}>Switch to Old Regime + invest in ELSS before 31 March. Your 80C has Rs.94,000 remaining.</p>
                    </div>
                  </div>
                </div>
      ...
      <section style={{ background: T.surface, borderTop: `1px solid ${T.border}`, borderBottom: `1px solid ${T.border}` }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", textAlign: "center", gap: "0" }}>
            {[
              { n: "618+", l: "Early access members" },
              { n: "Rs.2,400", l: "Avg. monthly waste found" },
              { n: "Rs.42,000", l: "Avg. annual tax saved" },
              { n: "18+", l: "Countries supported" },
              { n: "Free", l: "Core plan, forever" },
            ].map((s, i) => (
              <Fade key={i} delay={i * 0.06}>
                <div style={{ padding: "16px 12px", borderRight: i < 4 ? `1px solid ${T.border}` : "none" }}>
                  <p style={{ fontSize: "clamp(20px, 2.5vw, 28px)", fontWeight: "800", color: T.black, margin: "0 0 6px 0", letterSpacing: "-0.02em" }}>{s.n}</p>
                  <p style={{ fontSize: "12px", color: T.muted, margin: 0, lineHeight: "1.4" }}>{s.l}</p>
                </div>
              </Fade>
            ))}
          </div>
        ...
        <div style={W}>
          <Fade>
            <div style={{ textAlign: "center", maxWidth: "560px", margin: "0 auto 48px" }}>
              ...
              <p style={{ ...BODY, margin: 0 }}>Not from reckless spending — from missing deductions, forgotten subscriptions, and zero visibility.</p>
            </div>
          </Fade>
            ...
            {[
              ...
              <Fade key={i} delay={i * 0.07}>
                <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: "14px", padding: "24px" }}>
                  {/* Fixed: consistent font size for all stats */}
                  <p style={{ fontSize: "34px", fontWeight: "800", color: T.black, margin: "0 0 10px 0", letterSpacing: "-0.02em" }}>{p.n}</p>
      ...
      {/* 50/30/20 — CENTER header */}
      <section id="rule" style={{ background: T.black }}>
        <div style={W}>
          <Fade>
            <div style={{ textAlign: "center", maxWidth: "560px", margin: "0 auto 48px" }}>
              <span style={label(true)}>Built-in framework</span>
              <h2 style={{ ...H2, color: T.white }}>The 50/30/20 rule — adapted for India.</h2>
              <p style={{ fontSize: "17px", color: "rgba(255,255,255,0.45)", lineHeight: "1.7", margin: 0 }}>
                The most proven budgeting framework in the world, tuned for Indian salaries and tax laws. Applied automatically.
              </p>
            </div>
          </Fade>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "32px" }}>
            {rule.map((r, i) => (
              <Fade key={i} delay={i * 0.09}>
                <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "26px" }}>
                  <div style={{ marginBottom: "10px" }}>
                    <span style={{ fontSize: "50px", fontWeight: "800", color: r.color, letterSpacing: "-0.04em", lineHeight: 1 }}>{r.pct}</span>
                    <span style={{ fontSize: "22px", fontWeight: "800", color: r.color }}>%</span>
                  </div>
                  <p style={{ fontSize: "17px", fontWeight: "700", color: T.white, margin: "0 0 4px 0" }}>{r.label}</p>
                  <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.3)", margin: "0 0 18px 0" }}>
                  ...
                  {r.items.map((item, j) => (
                    <div key={j} style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "7px" }}>
                      ...
                      <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.48)" }}>{item}</span>
                    </div>
                  ))}
                </div>
              </Fade>
          ...
          <Fade delay={0.25}>
            {/* Example — clean, not AI-looking */}
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "28px 32px" }}>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.35)", margin: "0 0 20px 0", fontWeight: "600", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                Income: Rs.75,000/month
              </p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0" }}>
                {rule.map((r, i) => (
                  <div key={i} style={{ paddingRight: i < 2 ? "28px" : "0", borderRight: i < 2 ? "1px solid rgba(255,255,255,0.06)" : "none", paddingLeft: i > 0 ? "28px" : "0" }}>
                    <p style={{ fontSize: "11px", fontWeight: "700", color: r.color, letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 8px 0" }}>
                      {r.label} — {r.pct}%
                    </p>
                    <p style={{ fontSize: "26px", fontWeight: "800", color: T.white, margin: "0 0 4px 0", letterSpacing: "-0.02em" }}>{r.amount}</p>
                    <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.28)", margin: 0 }}>per month</p>
                  </div>
                ))}
              </div>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.2)", margin: "22px 0 0 0", borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: "18px" }}>
                  ...
                  <div style={{ ...CARD, padding: "40px 44px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "center" }}>
                    ...
                    <div style={{ order: flip ? 1 : 2 }}>
                      <div style={{ background: "#18181B", borderRadius: "11px", overflow: "hidden" }}>
                        ...
                        <pre style={{ fontSize: "12.5px", lineHeight: "1.85", color: "rgba(255,255,255,0.6)", margin: 0, padding: "16px 18px", fontFamily: "'Courier New', Menlo, monospace", whiteSpace: "pre-wrap" }}>
                          {f.code}
                        </pre>
                      </div>
                    </div>
      ...
      {/* COMPETITOR TABLE — CENTERED */}
      <section style={{ background: T.white }}>
        <div style={W}>
          <Fade>
            <div style={{ textAlign: "center", maxWidth: "480px", margin: "0 auto 48px" }}>
              <span style={label()}>Why Casha</span>
              <h2 style={H2}>Built for India. Built better.</h2>
              <p style={{ fontSize: "17px", color: T.muted, lineHeight: "1.7", margin: 0 }}>
                No other app covers your complete financial life for Indian users.
              </p>
            </div>
          </Fade>
          <Fade delay={0.1}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div style={{ border: `1px solid ${T.border}`, borderRadius: "14px", overflow: "hidden", width: "100%", maxWidth: "780px" }}>
        ...
        <div style={W}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "12px" }}>
            {[
              ...
              { n: "03", h: "AI analyzes everything", p: "Health score, budget, tax savings — all calculated instantly." },
              { n: "04", h: "Your wealth grows", p: "Follow the plan. Watch your score rise every month." },
            ].map((s, i) => (
              <Fade key={i} delay={i * 0.07}>
                <div style={CARD}>
                  <p style={{ fontSize: "38px", fontWeight: "800", color: T.border, margin: "0 0 16px 0", letterSpacing: "-0.03em", lineHeight: 1 }}>{s.n}</p>
      ...
      <section id="pricing" style={{ background: T.white, borderTop: `1px solid ${T.border}` }}>
        <div style={W}>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "14px", width: "100%", maxWidth: "860px" }}>
              {plans.map((plan, i) => (
                <Fade key={i} delay={i * 0.07}>
                  <div style={{
          ...
          <Fade delay={0.3}>
            <div style={{ display: "flex", justifyContent: "center", marginTop: "24px" }}>
              <div style={{ padding: "18px 24px", background: T.surface, border: `1px solid ${T.border}`, borderRadius: "12px", maxWidth: "860px", width: "100%" }}>
        ...
        <div style={W}>
          <Fade>
            <div style={{ textAlign: "center", maxWidth: "440px", margin: "0 auto 48px" }}>
              ...
              <p style={{ fontSize: "17px", color: T.muted, lineHeight: "1.7", margin: 0 }}>
                Early access members from our waitlist, tested for the past month.
              </p>
            </div>
          </Fade>
              ...
              <Fade key={i} delay={i * 0.07}>
                <div style={{ ...CARD, display: "flex", flexDirection: "column" }}>
                  <div style={{ display: "flex", gap: "2px", marginBottom: "14px" }}>
                    {[...Array(5)].map((_, j) => (
                      <svg key={j} width="13" height="13" fill="#F59E0B" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>
                    ))}
                  </div>
      ...
      <section style={{ background: T.black }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", padding: "88px 24px", textAlign: "center" }}>
          <Fade>
            <h2 style={{ fontSize: "clamp(30px, 5vw, 52px)", fontWeight: "800", color: T.white, letterSpacing: "-0.03em", lineHeight: "1.1", margin: "0 0 14px 0" }}>
              Start managing your money properly.{" "}
              <span style={{ color: T.green }}>Today.</span>
            </h2>
            <p style={{ fontSize: "18px", color: "rgba(255,255,255,0.4)", lineHeight: "1.65", margin: "0 0 32px 0" }}>
        ...
        <div style={{ maxWidth: "1080px", margin: "0 auto", padding: "32px 24px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
            ...
            <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.1)", margin: 0, maxWidth: "480px", textAlign: "right", lineHeight: "1.55" }}>
              Casha is a financial education platform. Not a SEBI-registered advisor, IRDAI agent, or licensed tax professional. All AI recommendations are educational only. Consult a qualified CA before making financial decisions.
            </p>
          </div>
        </div>
      </footer>
