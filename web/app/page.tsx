        ...
        <div style={W}>
          ...
          <Fade delay={0.22}>
            <div style={{
              ...
              <div>
                <p style={{ fontSize: "11px", fontWeight: "700", letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(34,197,94,0.82)", margin: "0 0 10px 0" }}>
                  Budget setup
                </p>
                <h3 style={{ fontSize: "22px", fontWeight: "800", color: "#FFFFFF", letterSpacing: "-0.02em", lineHeight: "1.2", margin: "0 0 8px 0" }}>
                  Start with your salary.
                  <br />
                  Casha handles the rest.
                </h3>
                <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.42)", lineHeight: "1.6", margin: "0 0 14px 0", maxWidth: "520px" }}>
                  Enter one number — your monthly income. Casha applies the India-adapted 50/30/20 framework and creates your complete budget instantly.
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {["Built from your income", "Editable anytime", "Works in under 1 minute"].map(item => (
                    <span key={item} style={{ fontSize: "12px", color: "rgba(255,255,255,0.62)", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "999px", padding: "6px 12px", whiteSpace: "nowrap" }}>
                      {item}
                    </span>
                  ))}
                </div>
              ...
              <a href="/auth/signup" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "13px 22px", borderRadius: "10px", background: T.green, color: T.black, textDecoration: "none", fontWeight: "700", fontSize: "14px", whiteSpace: "nowrap", flexShrink: 0, boxShadow: "0 6px 16px rgba(34,197,94,0.28)" }}
                onMouseEnter={e => e.currentTarget.style.opacity = "0.88"}
                onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
                Build my budget free →
              </a>
            </div>
          </Fade>
        </div>
              ...
              {plans.map((plan, i) => (
                <Fade key={i} delay={i * 0.07}>
                  <div style={{ background: plan.highlight ? T.black : T.white, border: plan.highlight ? `2px solid ${T.green}` : `1px solid ${T.border}`, borderRadius: "18px", padding: "30px", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", minHeight: "620px", boxShadow: plan.highlight ? "0 12px 32px rgba(34,197,94,0.10)" : "0 2px 10px rgba(0,0,0,0.03)" }}>
                    ...
                    <div>
                      <a href={plan.href} style={{ display: "block", textAlign: "center", padding: "13px", borderRadius: "10px", textDecoration: "none", fontWeight: "700", fontSize: "14px", fontFamily: "inherit", background: plan.highlight ? T.green : T.black, color: plan.highlight ? T.black : T.white, boxShadow: plan.highlight ? "0 6px 16px rgba(34,197,94,0.28)" : "none" }}
